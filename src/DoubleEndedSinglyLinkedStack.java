public class DoubleEndedSinglyLinkedStack<T> extends DoubleEndedSinglyLinkedStructure<T> implements Stack<T> { // T is the generic type

    public DoubleEndedSinglyLinkedStack() {
        super("Stack");
    }

    protected DoubleEndedSinglyLinkedStack(String type) {
        super(type);
    }
