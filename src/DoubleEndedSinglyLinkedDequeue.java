public class DoubleEndedSinglyLinkedDequeue<T> extends DoubleEndedSinglyLinkedStack<T> implements Queue<T> {

    public DoubleEndedSinglyLinkedDequeue() {
        super("Queue");
    }

    protected DoubleEndedSinglyLinkedDequeue(String type) {
        super(type);
    }
